...
# 获取全部数据文件名列表
PATH_IMAGE = '../data/Satellite_Building-dataset/images'
...
with open('../data/Satellite_Building-dataset/splits/train.txt', 'w') as f:
    f.writelines(line.split('.')[0] + '\n' for line in train_file_list)

with open('../data/Satellite_Building-dataset/splits/val.txt', 'w') as f:
